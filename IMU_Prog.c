...
enum_IMU_InitilizationfunctionStatus IMU_VidInit(void )
{
    ...
    case 0:
        Local_u8_Data[0] = PWR_MGMT_1;
        Local_u8_Data[1] = 0x00;
        IMU_Module.I2C_ChannelID = IMU_Configuration.I2C_Channel_Config;
        IMU_Module.ModuleStatus = IMU_NOT_INITIALIZED;
        I2C_MasterRequestToSend(IMU_Module.I2C_ChannelID,Local_u8_Data,2,( (u8) IMU_Configuration.AD0_status + MODULE_ADRDRESS ),Single_Start_Condition);
        break;

        /* ===================================== sample rate division for the internal adc ======================================*/
    case 1:
        Local_u8_Data[0] = SMPLRT_DIV;
        Local_u8_Data[1] = 0x07;
        I2C_MasterRequestToSend(IMU_Module.I2C_ChannelID,Local_u8_Data,2,( (u8) IMU_Configuration.AD0_status + MODULE_ADRDRESS ),Single_Start_Condition);
        break;
        /* ==================================== Select the X-gyroscope pll internal clock ======================================*/
    case 2:
        Local_u8_Data[0] = PWR_MGMT_1;
        Local_u8_Data[1] = IMU_Configuration.Clock;
        I2C_MasterRequestToSend(IMU_Module.I2C_ChannelID,Local_u8_Data,2,( (u8) IMU_Configuration.AD0_status + MODULE_ADRDRESS ),Single_Start_Condition);
        break;
        /* ==================================== Setting the DLPF to 0 to synch the gyro and accel readings ======================================*/
    case 3:
        Local_u8_Data[0] = CONFIG;
        Local_u8_Data[1] = 0x00;
        I2C_MasterRequestToSend(IMU_Module.I2C_ChannelID,Local_u8_Data,2,( (u8) IMU_Configuration.AD0_status + MODULE_ADRDRESS ),Single_Start_Condition);
        break;
    ...
    case 4:
        Local_u8_Data[0] = ACCEL_CONFIG;
        Local_u8_Data[1] = IMU_Configuration.Accelerometer_Range;
        I2C_MasterRequestToSend(IMU_Module.I2C_ChannelID,Local_u8_Data,2,( (u8) IMU_Configuration.AD0_status + MODULE_ADRDRESS ),Single_Start_Condition);
        break;
        /* ==================================== Gyroscope full scale range set to 250 degree/sec ======================================*/

    case 5:
        Local_u8_Data[0] = GYRO_CONFIG;
        Local_u8_Data[1] = IMU_Configuration.Gyroscope_Range;
        I2C_MasterRequestToSend(IMU_Module.I2C_ChannelID,Local_u8_Data,2,( (u8) IMU_Configuration.AD0_status + MODULE_ADRDRESS ),Single_Start_Condition);
        break;
